# Generate the beta's from Model 2 and their rank (Men)
# Original Date: 5/23/2017
# Version Date: 4/24/2019

# Update:
# 5/12/2018 - Add 2017-2018 season. Create Design Matrix that apply zero constraint 
#             on coefficients before fitting linear model. Remove the games after 
#             the starting date of NCAA tournament.
